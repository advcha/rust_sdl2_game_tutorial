...
// WARNING: Calling this function too often or at a variable speed will cause the player's speed to be unpredictable!
...
fn main() -> Result<(), String> {
    ...
    let window = video_subsystem.window("SDL2 Game Tutorial", 800, 600)
        .position_centered()
        .build()
